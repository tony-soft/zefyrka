...
class TextLine extends StatelessWidget {
  ...
  TextStyle _getInlineTextStyle(NotusStyle style, ZefyrThemeData? theme) {
    ...
    final highlight = style.get(NotusAttribute.highlight);
    if (highlight == NotusAttribute.highlightYellow) {
      result = _mergeTextStyleWithDecoration(result, theme!.highlightYellow);
    } else if (highlight == NotusAttribute.highlightRed) {
      result = _mergeTextStyleWithDecoration(result, theme!.highlightRed);
    } else if (highlight == NotusAttribute.highlightBlue) {
      result = _mergeTextStyleWithDecoration(result, theme!.highlightBlue);
    }
